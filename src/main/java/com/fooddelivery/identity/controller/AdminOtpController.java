...
public class AdminOtpController {
    ...
    @GetMapping("/otp")
    public ResponseEntity<ApiResponse<String>> getOtp(@RequestParam String phoneNumber, @RequestParam(defaultValue = "CUSTOMER") String serviceName) {
    ...
    @java.lang.SuppressWarnings("all")
    public AdminOtpController(final CachePort cachePort) {

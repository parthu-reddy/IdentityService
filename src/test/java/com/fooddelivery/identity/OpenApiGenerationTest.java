...
public class OpenApiGenerationTest {
    ...
    private com.fooddelivery.identity.repository.UserRepository userRepository;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.identity.service.InternalUserService internalUserService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.identity.service.AuthService authService;

    @org.springframework.boot.autoconfigure.SpringBootApplication(scanBasePackages = {"com.fooddelivery.identity.controller"}, excludeName = {"org.springframework.boot.autoconfigure.security.servlet.SecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.servlet.ManagementWebSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.reactive.ReactiveSecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.reactive.ManagementReactiveSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.oauth2.resource.servlet.OAuth2ResourceServerAutoConfiguration"})
